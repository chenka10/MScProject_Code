...
models_dir = f'/home/chen/MScProject/Code/experiments/rarp50/Blobs_LSTM/test_models_{params['conditioning']}/2_blobs_framesize_{params['frame_size']}_leave_{params['video_to_leave']}_models_{timestamp}_{runid}_origis_{orig_run_id_to_test}/'
images_dir = f'/home/chen/MScProject/Code/experiments/rarp50/Blobs_LSTM/test_images_{params['conditioning']}/2_blobs_framesize_{params['frame_size']}_leave_{params['video_to_leave']}_images_{timestamp}_{runid}_origis_{orig_run_id_to_test}/'
